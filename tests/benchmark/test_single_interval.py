...
class TestInit(unittest.TestCase):
    def test_successful(self):
        ...
        with patch(
            "benchmarking.src.test_types.base.SingleIntervalTest._SingleIntervalTest__get_total_message_count"
            ...
            sut = SingleIntervalTest(
                test_full_length_in_minutes, test_messages_per_second
            )
...
class TestExecuteCore(unittest.TestCase):
    ...
    def test_successful(self):
        ...
        with patch("benchmarking.src.test_types.base.datetime") as mock_datetime, patch(
            ...
            "benchmarking.src.test_types.base.SingleIntervalTest._get_time_elapsed"
