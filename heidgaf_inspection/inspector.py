...
class Inspector:
    ...
    def get_and_fill_data(self):
        if self.busy:
            logger.warning("Inspector is busy! Not consuming new data.")
            return

        self.data = self.kafka_consume_handler.consume_and_return_json_data()
    ...
    def clear_data(self):
        ...
        logger.info("Cleared data. Inspector is now available.")
